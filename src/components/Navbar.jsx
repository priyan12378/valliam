...
export default function Navbar() {
  ...
  return (
    /* UPDATED: Added w-full to ensure navbar never exceeds screen bounds */
    <nav className="navbar sticky top-0 z-50 w-full bg-white border-b border-gray-100 shadow-sm transition-all duration-300">
      
      {/* Top Colorful Line */}
      <div className="h-1 w-full" style={{ background: 'linear-gradient(90deg, #E60000 0%, #007BFF 50%, #E60000 100%)' }}></div>

      {/* UPDATED: Added w-full and changed px-6 to px-4 md:px-6 for tighter mobile padding */}
      <div className="max-w-[1440px] w-full mx-auto px-4 md:px-6 py-4">
        <div className="flex justify-between items-center h-20">
          
          {/* =================================================================
              1. LOGO SECTION (UPDATED FOR MOBILE RESPONSIVENESS)
             ================================================================= */}
          {/* UPDATED: Changed mr-10 to xl:mr-10 to remove the huge right margin on mobile. Adjusted gap for mobile. */}
          <Link to="/" className="flex items-center gap-2 md:gap-3 cursor-pointer group flex-shrink-0 xl:mr-10">
            {/* UPDATED: Responsive image height (h-10 on mobile, h-12 on desktop) */}
            <img src={logoImage} alt="Valliam Logo" className="h-10 md:h-12 w-auto object-contain" />
            
            <div className="flex items-center">
              {/* UPDATED: Responsive font size (text-3xl on mobile, text-5xl on desktop) */}
              <span className="text-3xl md:text-5xl font-bold tracking-tighter leading-none transform translate-y-[2px]" 
                    style={{ color: '#E60000', fontFamily: 'Rajdhani, sans-serif' }}>
                VALLIAM
              </span>
              
              {/* UPDATED: Responsive divider spacing (mx-2 on mobile, mx-4 on desktop) */}
              <div className="h-8 md:h-10 w-px bg-gray-400 mx-2 md:mx-4"></div>
              
              {/* UPDATED: Scaled down tagline text slightly on mobile so it doesn't break to a new line */}
              <div className="flex flex-col justify-center leading-none">
                <span className="text-[10px] md:text-sm font-medium tracking-wide text-gray-600 uppercase" 
                      style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
                  Technical
                </span>
                <span className="text-[10px] md:text-sm font-medium tracking-wide text-gray-600 uppercase" 
